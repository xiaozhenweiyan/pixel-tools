...
(function () {
  ...
  const translations = {
    zh: {
      ...
      pixel_ai_tutorial_title: '使用教程',
      pixel_ai_tutorial_step1: '第一步：获取 API Key',
      pixel_ai_tutorial_step1_desc: '访问您选择的 AI 服务商网站，注册账号并获取 API Key。',
      pixel_ai_tutorial_provider_openai: 'OpenAI: https://platform.openai.com/api-keys',
      pixel_ai_tutorial_provider_anthropic: 'Anthropic: https://console.anthropic.com/settings/keys',
      pixel_ai_tutorial_provider_google: 'Google: https://aistudio.google.com/app/apikey',
      pixel_ai_tutorial_provider_qwen: '通义千问: https://dashscope.console.aliyun.com/apiKey',
      pixel_ai_tutorial_provider_ernie: '文心一言: https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application',
      pixel_ai_tutorial_provider_deepseek: 'DeepSeek: https://platform.deepseek.com/api_keys',
      pixel_ai_tutorial_provider_mistral: 'Mistral: https://console.mistral.ai/api-keys/',
      pixel_ai_tutorial_provider_groq: 'Groq: https://console.groq.com/keys',
      pixel_ai_tutorial_step2: '第二步：配置模型',
      pixel_ai_tutorial_step2_desc: '点击右上角「设置」按钮，选择模型提供商、模型版本，然后输入您的 API Key。',
      pixel_ai_tutorial_step3: '第三步：开始对话',
      pixel_ai_tutorial_step3_desc: '在底部输入框中输入您的问题，按 Enter 发送。Shift+Enter 换行。',
      pixel_ai_tutorial_errors: '常见错误及解决方法',
      pixel_ai_error_guide_auth: '认证失败',
      pixel_ai_error_guide_auth_desc: '检查 API Key 是否正确，没有多余空格或换行符。',
      pixel_ai_error_guide_bad_request: '请求参数错误',
      pixel_ai_error_guide_bad_request_desc: '检查模型名称是否正确，或输入内容格式是否有误。',
      pixel_ai_error_guide_rate: '请求过于频繁',
      pixel_ai_error_guide_rate_desc: 'API 调用次数超过限制，请稍后再试或升级套餐。',
      pixel_ai_error_guide_cors: '跨域错误',
      pixel_ai_error_guide_cors_desc: '检查 API Base URL 是否正确，有些服务商需要使用特定的 API 地址。',
      pixel_ai_error_guide_server: '服务器错误',
      pixel_ai_error_guide_server_desc: '服务商服务器暂时不可用，请稍后重试。',
      pixel_ai_error_guide_network: '网络错误',
      pixel_ai_error_guide_network_desc: '检查网络连接，确保可以访问互联网。',
      pixel_ai_tutorial_close: '关闭',
    ...
    en: {
      ...
      pixel_ai_tutorial_title: 'User Guide',
      pixel_ai_tutorial_step1: 'Step 1: Get API Key',
      pixel_ai_tutorial_step1_desc: 'Visit your chosen AI provider website, register an account, and obtain an API Key.',
      pixel_ai_tutorial_provider_openai: 'OpenAI: https://platform.openai.com/api-keys',
      pixel_ai_tutorial_provider_anthropic: 'Anthropic: https://console.anthropic.com/settings/keys',
      pixel_ai_tutorial_provider_google: 'Google: https://aistudio.google.com/app/apikey',
      pixel_ai_tutorial_provider_qwen: 'Qwen: https://dashscope.console.aliyun.com/apiKey',
      pixel_ai_tutorial_provider_ernie: 'ERNIE: https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application',
      pixel_ai_tutorial_provider_deepseek: 'DeepSeek: https://platform.deepseek.com/api_keys',
      pixel_ai_tutorial_provider_mistral: 'Mistral: https://console.mistral.ai/api-keys/',
      pixel_ai_tutorial_provider_groq: 'Groq: https://console.groq.com/keys',
      pixel_ai_tutorial_step2: 'Step 2: Configure Model',
      pixel_ai_tutorial_step2_desc: 'Click the "Settings" button in the top right corner, select the AI provider and model version, then enter your API Key.',
      pixel_ai_tutorial_step3: 'Step 3: Start Chatting',
      pixel_ai_tutorial_step3_desc: 'Enter your question in the bottom input box, press Enter to send. Shift+Enter for newline.',
      pixel_ai_tutorial_errors: 'Common Errors and Solutions',
      pixel_ai_error_guide_auth: 'Authentication Failed',
      pixel_ai_error_guide_auth_desc: 'Check if your API Key is correct, with no extra spaces or line breaks.',
      pixel_ai_error_guide_bad_request: 'Bad Request',
      pixel_ai_error_guide_bad_request_desc: 'Check if the model name is correct, or if the input format is invalid.',
      pixel_ai_error_guide_rate: 'Rate Limit Exceeded',
      pixel_ai_error_guide_rate_desc: 'API call limit exceeded. Please try again later or upgrade your plan.',
      pixel_ai_error_guide_cors: 'CORS Error',
      pixel_ai_error_guide_cors_desc: 'Check if the API Base URL is correct. Some providers require specific API endpoints.',
      pixel_ai_error_guide_server: 'Server Error',
      pixel_ai_error_guide_server_desc: 'The provider\'s server is temporarily unavailable. Please try again later.',
      pixel_ai_error_guide_network: 'Network Error',
      pixel_ai_error_guide_network_desc: 'Check your network connection and ensure you have internet access.',
      pixel_ai_tutorial_close: 'Close',
      pixel_ai_provider_openai: 'OpenAI',
      pixel_ai_provider_anthropic: 'Anthropic',
      pixel_ai_provider_google: 'Google Gemini',
